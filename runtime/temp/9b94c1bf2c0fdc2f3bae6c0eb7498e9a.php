<?php /*a:2:{s:89:"I:\Project\WebServer\www\project\Hy\application\index\view\delivery\delivery-details.html";i:1543143591;s:77:"I:\Project\WebServer\www\project\Hy\application\index\view\public\header.html";i:1542108818;}*/ ?>
﻿ <!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
  <?php if($show): ?>
  <xblock>
    <a class="layui-btn"  target="_blank" href="<?php echo url('index/Delivery/deliveryDetails',['deliverId'=>$deliveryId,'show'=>'0']); ?>"><i class="iconfont">&#xe718;</i> 框架页面</a>
    <button class="layui-btn" onclick="x_admin_show('选择明细','<?php echo url('index/Delivery/selectOrder',['deliveryId'=>$deliveryId]); ?>')"><i class="layui-icon"></i>添加订单</button>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="#" onclick="x_admin_show('修改明细','<?php echo url('index/Delivery/editOrder',['id'=>$info['id'],'quantity'=>$info['quantity'],'remarks'=>$info['remarks']]); ?>',500,300)" style="color:green;">
...
<script>
    ...
    function delete_(obj,id){
        layer.confirm('从发货单列表中删除？',function(index){
            var url = "<?php echo url('/index/Delivery/delOrder'); ?>";
            var postData ={"id":id};
    ...
    function updateNum(id){
        ...
        layer.confirm("明细: <span style='color: green'>"+id+"</span> <br>发货数量改为: <span style='color: green'>"+number+"</span> <br> 确认吗？",function(index){
            var url = "<?php echo url('/index/Delivery/updateNum'); ?>";
