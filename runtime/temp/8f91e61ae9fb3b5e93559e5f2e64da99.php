<?php /*a:2:{s:93:"I:\Project\WebServer\www\project\Hy\application\index\view\blueprint\add-drawing-externa.html";i:1541478154;s:77:"I:\Project\WebServer\www\project\Hy\application\index\view\public\header.html";i:1542108818;}*/ ?>
 <!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <form  class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  <input type="hidden" id="create_name" name="create_name" value="<?php echo htmlentities(app('session')->get('user.user_name')); ?>">
