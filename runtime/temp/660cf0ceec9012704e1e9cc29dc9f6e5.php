<?php /*a:2:{s:82:"I:\Project\WebServer\www\project\Hy\application\index\view\bao_jia\view_order.html";i:1544244861;s:77:"I:\Project\WebServer\www\project\Hy\application\index\view\public\header.html";i:1542108818;}*/ ?>
 <!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        top.SearchTeacherLayerId = top.layer.open({
            ...
            success: function () {
                $(top.document.body).find('#layui-layer-iframe' + top.SearchTeacherLayerId).contents().find("td a").on('click', function () {
                    ...
                    var url = "<?php echo url('index/BaoJia/addNexus'); ?>";
