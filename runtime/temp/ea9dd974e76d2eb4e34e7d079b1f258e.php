<?php /*a:2:{s:91:"I:\Project\WebServer\www\project\Hy\application\index\view\internal\add-drawing-detial.html";i:1541513383;s:77:"I:\Project\WebServer\www\project\Hy\application\index\view\public\header.html";i:1541478155;}*/ ?>
 <!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" title="无法编辑" value="<?php echo htmlentities($newDetial); ?>" id="drawing_detail_id"  disabled="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">内图编号</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" title="无法编辑" value="<?php echo htmlentities($internal); ?>" id="addMidNumberInput"  disabled="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">外图编号</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value=""  title="无法编辑" id="drawing_external_id" disabled="">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select  name="modules" lay-verify="required"  id="client_id">
        ...
        <div >
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="files_state" lay-skin="switch" lay-text="是|否"  id="files_state">
            </div>
        ...
        $("#addData").on("click",function () {
           ...
           var if_batch = $("#if_batch:checked").val();
            ...
            if(drawing_external_name==" "){
                ...
                //写入图纸明细信息
                $.ajax({
                    url:"<?php echo url('index/Internal/createDetial'); ?>",
                    type:"POST",
                    dataType:"json",
                    data:{"json":jsonData},
