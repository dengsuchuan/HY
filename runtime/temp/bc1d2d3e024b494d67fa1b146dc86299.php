<?php /*a:2:{s:78:"I:\Project\WebServer\www\project\Hy\application\index\view\quote\viewshow.html";i:1544245894;s:77:"I:\Project\WebServer\www\project\Hy\application\index\view\public\header.html";i:1542108818;}*/ ?>
 <!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body" >
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加单据','<?php echo url('index/Quote/addquote'); ?>',500,600)"><i class="layui-icon"></i>添加单据</button>
        <!--<a class="layui-btn" href="<?php echo url('index/Quote/viewShow',['action'=>$action]); ?>" title="<?php echo !empty($action) ? '切换到已确认列表' : '切换到未确认列表'; ?>"><i class="layui-icon"></i><?php echo !empty($action) ? '切换到已确认列表' : '切换到未确认列表'; ?></a>-->
        <span class="x-right" style="line-height:40px">共<?php echo htmlentities($quoteCount); ?>条 · 共<?php echo htmlentities(getInt($quoteCount/25)); ?>页</span>
    </xblock>
        ...
        <div class="box-1">
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><a href="#" style="color: green" onclick="x_admin_show('<?php echo htmlentities($list['quoteId']); ?>的报价明细','<?php echo url('index/Quoted/viewshow',['quoteId'=>$list['quoteId']]); ?>')"><?php echo htmlentities($list['quoteId']); ?></a></td>
